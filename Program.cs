...
namespace ResponsiPemrograman4331
{
    class Program
    {
        ...
        {
            Karyawan karyawan1 = new Karyawan(12323212, "pujengot", 6000000);
            Karyawan karyawan2 = new Karyawan(12321321, "majengot", 9000000);
            Karyawan karyawan3 = new Karyawan(12323123, "jengot", -400000);
